...
public class TfLiteReIdentifier {

    private final String TAG = "TfLiteReIdentifier";

    //Params for TFlite interpreter
    private final boolean IS_QUANTIZED = false;
    private final int[] INPUT_SIZE = {256, 128};
    private final int OUTPUT_SIZE = 256;
    ...
    private final String MODEL_NAME = "retail-0287model_integer_quant.tflite";
//    private final String MODEL_NAME = "retail-0287model_float32.tflite";

    private Interpreter tfLite;
    private HexagonDelegate hexagonDelegate;


    public TfLiteReIdentifier(Context context){
    ...
    protected ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        ...
        int[] intValues = new int[INPUT_SIZE[0] * INPUT_SIZE[0]];
