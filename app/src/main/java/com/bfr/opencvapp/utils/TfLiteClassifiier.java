...
/** TFLite implementation of standard classifier*/
public class TfLiteClassifiier {

    private final String TAG = "TfLiteClassifier";

    //Params for TFlite interpreter
    private final boolean IS_QUANTIZED = false;
    private final int[] INPUT_SIZE = {224,224};
    private final int[] OUTPUT_SIZE = {1,1000}; // 20 bounding box max per class -> 20x3 = 60,
...
//    private final String MODEL_NAME = "yolox_t_body_head_hand_post_0299_0.4522_1x3x192x416_float32.tflite";
    private final String MODEL_NAME = "image_classification_ppresnet50_2022jan_float16.tflite";
//    private final String MODEL_NAME = "TopFormer-S_512x512_2x8_160k_argmax.tflite";
    ...
    public TfLiteClassifiier(Context context){
     ...
     */
    public float[] runInference(Mat frame) {
...
//        tfLite.run(byteBuffer, outputBuffer);
        ...
        ArrayList<TfLiteClassifiier.Recognition> listOfDetections = new ArrayList<TfLiteClassifiier.Recognition>();
